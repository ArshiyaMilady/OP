...
{
    public partial class M1100_StockInventory : X210_ExampleForm_Normal
    {
        public M1100_StockInventory()
        {
            InitializeComponent();
        ...
        private void M1100_StockInventory_Shown(object sender, EventArgs e)
        {
            if (Stack.UserLevel <= Stack.UserLevel_Supervisor1)
            {
                btnDeleteAll.Visible = true;
        ...
        private List<Models.Warehouse_Inventory> GetData()
        {
                ...
                if (bIsBOM_sheetExists)
                {
                        ...
                        == DialogResult.Yes)
                    {
                        ...
                        while (true)
                        {
                            ...
                            {
                                Models.Warehouse_Inventory wi = new Models.Warehouse_Inventory
                                {
                            ...
                            {
                                Models.Warehouse_Inventory wi = Program.dbOperations.GetWarehouse_InventoryAsync(item_Small_code);
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            //ShowData(false);
            List<Models.Warehouse_Inventory> lstWI = (List<Models.Warehouse_Inventory>)dgvData.DataSource;
        ...
        // جستجوی موردی
        private List<Models.Warehouse_Inventory> SearchThis(List<Models.Warehouse_Inventory> lstWI1, string TextBoxName)
        {
            switch (TextBoxName)
            {
        ...
        private void DgvData_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Models.Warehouse_Inventory wi = Program.dbOperations.GetWarehouse_InventoryAsync(index);
